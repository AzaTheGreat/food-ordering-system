...
public class Company implements BaseEntity<Integer> {
    ...
    public Company(int man_id, String name_en, String gmc_report_type, String gmc_report_url, String description) {
        this.man_id = man_id;
    ...
    public Company(String name_en, String gmc_report_type, String gmc_report_url, String description) {
        this.name_en = name_en;
        this.gmc_report_type = gmc_report_type;
        this.gmc_report_url = gmc_report_url;
        this.description = description;
    ...
    public Company(int man_id, String name_en, String name_cn, String gmc_report_type, String gmc_report_url, String description, String created_by, Date creation_date, String last_update_by, Date last_update_date, int call_cnt, String remark, String sts_cd) {
        this.man_id = man_id;
        this.name_en = name_en;
