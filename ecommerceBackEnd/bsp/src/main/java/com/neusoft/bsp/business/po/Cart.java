...
public class Cart implements BaseEntity<Integer> {
    int wit_id;
    int dsr_id;
    int pro_id;
    String created_by;
    ...
    public Cart(int pro_id) {
        this.pro_id = pro_id;
    }

    public Cart(int wit_id, int dsr_id, int pro_id, String created_by, Date creation_date, String last_update_by, Date last_update_date, int call_cnt, String remark, String sts_cd) {
        this.wit_id = wit_id;
        this.dsr_id = dsr_id;
        this.pro_id = pro_id;
