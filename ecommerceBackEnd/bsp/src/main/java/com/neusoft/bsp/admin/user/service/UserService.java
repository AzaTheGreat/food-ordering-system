...
public interface UserService {
    ...
    static String BVODEFAULT = "BVOmyInfo,BVOshopManagement,BVOproductPreview,BVOcart,BVObillManagement,BVOwallet";

    static String ADMINDEFAULT = "MVOmyInfo,MVOrecordProduct,MVOproductPicture,MVObillManagement,MVOwallet,"+
            "BVOmyInfo,BVOshopManagement,BVOproductPreview,BVOcart,BVObillManagement,BVOwallet"+
