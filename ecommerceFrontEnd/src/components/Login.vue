  ...
  <div class="flex">
    ...
    <transition name="el-zoom-in-left">
      <div v-show="showlogin" class="box">
        <h2 class="title" style="margin-left: 10%">Online Food Ordering System</h2>
        <el-input
          style="width:24rem; margin-left: 5%"
          class="input"
          v-model="username"
        ...
        <div>
          <el-input
            style="width:18rem; margin-left: 5%"
            class="input"
            v-model="checkCode"
        ...
        <el-button class="btn" type="primary" style=" margin-left: 22%"@click="login">Login</el-button>
        <el-link
          class="register"
        ...
        >registration</el-link>
      </div>
    </transition>

    <transition name="el-zoom-in-left">
      <div v-show="showRegister" class="box-register">
        <h2 class="title" style="width:24rem;margin-left: 35%">Registration</h2>
        <el-input
          style="width:24rem; margin-left: 5%"
          class="input"
          v-model="username"
        ...
        ></el-input>
        <div class="radio"style="width:24rem; margin-left: 33%">
          <el-radio v-model="role_id" label="1">Seller</el-radio>
          <el-radio v-model="role_id" label="2">User</el-radio>
        </div>
        <el-button class="btn" type="primary" style="margin-left: 23%"@click="register">Register</el-button>
        <el-link
          class="register"
          style="margin-left: 40.5%"
          type="primary"
