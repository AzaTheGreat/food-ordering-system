          ...
          <div style="width:25rem">
            ...
            <el-popover placement="bottom" v-model="dialogVisible">
              ...
              <div class="minibtn">
                ...
                <el-button size="mini" type="primary" plain @click="pushShip">Confirm</el-button>
              </div>
              <el-button type="danger" slot="reference">Order Now</el-button>
            </el-popover>
            <el-button
              type="danger"
              @click="star(chooseItem)"
            >{{chooseItem.star == 1 ? 'Remove from Cart' : 'Add to Cart'}}</el-button>
          </div>
        </div>
        <br />
