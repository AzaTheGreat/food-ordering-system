<template>
  <div>
    ...
    <el-button type="primary" icon="el-icon-plus" @click="dialogVisible = true; isAdd=true">Add</el-button>
    ...
    <el-dialog title="Parameter info" :visible.sync="dialogVisible" width="30%">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitForm('paramForm')">Confirm</el-button>
