<template>
  <div>
    ...
    <div v-show="emptyShow" class="empty-box">
      ...
      <el-button type="primary" @click="drawer=true">Fill Company information</el-button>
    </div>
    ...
    <div v-show="mainShow" class="main-box-top">
      <div>
        ...
        <br />
        <el-button type="primary" @click="changeCompanyInfo">Update</el-button>
      </div>
      <div class="main-box-top">
        <el-link style="font-size:18px" :underline="false" type="success">Restaurant information</el-link>
        <el-divider></el-divider>
        <span>
          Search：
          <el-input
        ...
        <el-table size="medium" :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" style="width: 100%" height="301">
          <el-table-column prop="brdid" label="Restaurant Id"></el-table-column>
          <el-table-column prop="name" label="Restaurant Name"></el-table-column>
          <!-- <el-table-column prop="logo" label="Brand Logo"></el-table-column> -->
          <el-table-column prop="logo" label="Restaurant Logo">
    ...
    <el-dialog title="Add Restaurant information" :visible.sync="dialogVisible" width="23%">
      <span>
        Restaurant Name：
    ...
    <el-dialog title="Update Restaurant information" :visible.sync="dialogVisible1" width="23%">
      <span>
        Restaurant Name：
        <el-input style="width:250px" v-model="brandname" placeholder></el-input>
      </span>
...
export default {
  ...
  methods: {
    ...
    checkCompany() {
      ...
      this.$post("/MVO/getCompanyByUserID", {
