  ...
  <div>
      ...
      <el-tab-pane label="Awaiting Shipment" name="second">
        ...
        >
          ...
          <el-table-column label="operation">
            <template slot-scope="scope">
              <el-button type="primary" size="small" @click="ship(scope.row, scope.$index)">Shipment</el-button>
            </template>
          </el-table-column>
        </el-table>
        <br />
        <el-button type="primary" size="medium" @click="shipSelected">Ship Selected</el-button>
      </el-tab-pane>
    ...
    <el-dialog title="Tracking Company" :visible.sync="dialogVisible" width="30%">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitForm('trackTable')">Ship</el-button>
